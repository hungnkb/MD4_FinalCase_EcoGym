...
authRouter.get("/login", authorize_1.default.guest, auth_controller_1.default.showLogin);
...
authRouter.get("/register", authorize_1.default.guest, auth_controller_1.default.showRegister);
